...
class SpecialRectificationList(KeyWords):
    ...
    # 查看专项整治详情
    url_img = (By.XPATH, '//div[@class="special-rectification-list-view-content"]/div[1]/div[1]')
    ...
    def special_rectification_filter(self):
        ...
        self.wait(1)
        # 清空sous
        self.hover(args=self.search_name, context='搜索框')
        self.click(args=self.search_clear, context='清空')
        # 点击收藏按钮
...
if __name__ == '__main__':
    ...
    case.special_rectification_detail_and_update()
